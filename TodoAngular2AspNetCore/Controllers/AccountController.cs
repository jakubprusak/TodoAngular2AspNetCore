...
using TodoAngular2AspNetCore.Models.AccountViewModels;
using TodoAngular2AspNetCore.Public.Common;
...
namespace TodoAngular2AspNetCore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private OperationResult AddErrors(IdentityResult result)
        {
            OperationResult or = new OperationResult();
            foreach (var error in result.Errors)
            {
                or.Errors.Add(error.Description);
            }
